...
final class SettingsStore: ObservableObject {
    ...
    enum Model: String, CaseIterable, Identifiable {
        ...
        var label: String {
            switch self {
            case .haiku:  return "Haiku 4.5 — schnell & günstig"
            case .sonnet: return "Sonnet 4.6 — ausgewogen"
            case .opus:   return "Opus 4.7 — leistungsstark"
            }
        }
        var contextWindow: String {
            switch self {
            case .haiku:  return "200K Token Kontext"
            case .sonnet: return "200K Token Kontext"
            case .opus:   return "200K Token Kontext"
            }
        }
    }
    ...
    enum AutoCollapse: String, CaseIterable, Identifiable {
        ...
        var label: String {
            switch self {
            case .off:   return "Aus"
            case .sec5:  return "5 Sekunden"
            case .sec10: return "10 Sekunden"
            case .sec30: return "30 Sekunden"
            }
        }
